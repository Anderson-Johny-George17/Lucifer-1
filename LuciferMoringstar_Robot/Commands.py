...
from Config import START_MSG, CHANNELS, ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, https://t.me/flix_corner, BROADCAST_CHANNEL, DB_URL, SESSION, ADMIN_ID    
    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton("⚜️ OUR GROUP ⚜️", url="https://t.me/Flixcorner_group")
                    ],
                    [
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("More Botz", url="https://t.me/Flix_Updates")
                ],[
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('UPDATE CHANNEL', url='https://t.me/flix_updates'),
            InlineKeyboardButton('⚜️ OUR GROUP ⚜️ ', url='https://t.me/flixcorner_updates')
        ]
        ]
